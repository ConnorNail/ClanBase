...
export default function editGroupGeneralSettings(membershipOption, newMembersOption, language, ggOption, adminSendInvites, adminEditCulture, adminsEditBanner, clanId, send, setSend) {
