    ...
    return (
        <DefaultTemplate>
            <Head>
                ...
                <meta
                    name="description"
                    content="Destiny 2 clan score definitions."
                    key="desc"
                />
            </Head>
                ...
                <Col size={{ xs: "11", md: "8" }}>
                    <InfoBox bg="cbGrey1" m={{ y: "0.5rem" }}>
                        <Div m={{ x: "2rem", y: "1rem" }}>
                            ...
                            <Body>The way in which we calculate these scores is a secret for now while we finalize the algorithm but it takes into account multiple factors across many areas of the game. It should be noted, however, that the number of members in a clan is accounted for and does not significantly impact the score assigned to a clan unless a clan has very few members. This ensures that the scores can be used to compare clans regardless of how many players are a part of them. The clan score for the average clan of 100 members is 1000 for both PvE and PvP.</Body>
                        </Div>
                    </InfoBox>
                </Col>
            </Div>
